"""Vehicle geometry, collision checks, and kinematic updates."""
...
def check_car_collision(xlist, ylist, yawlist, ox, oy, kdtree):
    """Check whether a vehicle footprint sequence is collision-free."""
...
def rectangle_check(x, y, yaw, ox, oy):
    """Check obstacle points against the vehicle rectangle in body frame."""
...
def plot_car(x, y, yaw):
    """Draw a simple vehicle rectangle and heading arrow."""
    car_color = '-k'
    c, s = cos(yaw), sin(yaw)
...
def move(x, y, yaw, distance, steer, L=WB):
    """Move a kinematic bicycle state by distance and steering angle."""
    x += distance * cos(yaw)
    y += distance * sin(yaw)
