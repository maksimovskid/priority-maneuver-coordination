"""Three-vehicle coordination scenario using the four-message protocol.

This variant follows the request/offer/confirm/accept flow so the requester can
confirm the combined response before the accepting vehicles commit.
"""
...
def main(*, show_animation: bool = True, save_output_dir: str | None = None, save_animation: bool = False):
    """Set up and run the three-vehicle four-message simulation."""
    print("start simulation: three_vehicles_coordination_4_messages")

    ox, oy, ox2, oy2, obstacle_list = build_obstacles()
    vehicle_configs = build_default_three_vehicle_coordination_4_messages_configs()
    ...
    print("end simulation: three_vehicles_coordination_4_messages")
